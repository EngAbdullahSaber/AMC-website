                                ...
                                <div class="row" style="justify-content:space-evenly">
                                    ...
                                    <div class="col-lg-12 form-Roles mb-3">
                                        ...
                                        <div class="col-lg-12 form-Roles mb-3">
                                            <div class="d-flex justify-content-center mt-3">
                                                <img src="" class="w-70 "
                                                    style="max-width: 300px; max-height: 150px" id="img_edit"
                                                    alt="">
                                                <img src="" class="w-70 "
                                                    style="max-width: 300px; max-height: 150px" id="img2_edit"
                                                    alt="">
                                            </div>
                                            <label class="form-label" for="customFile">
                                                {{ __('validation.choose_img_2') }}
                                            </label>
                                            <input class="form-control" name="img2" accept="image/*"
                                                type="file" />
                                        </div>
                                    </div>
                                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 404) {
                            ...
                            $('#img2_edit').attr('src', response.img2)
