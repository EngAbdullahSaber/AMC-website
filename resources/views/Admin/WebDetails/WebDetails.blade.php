                    ...
                    <div class="table-responsive mt-3 scrollbar">
                        <table class="table table-bordered table-striped fs--1 mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ __('validation.contact_en') }} </td>
                                    <td>
                                        <input type="text" name="des_en" class="form-control des_en">
                                    </td>
                                </tr>
                                <tr>
                                    <td>{{ __('validation.contact_ar') }} </td>
                                    <td>
                                        <input type="text" name="des_ar" class="form-control des_ar">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-center mt-3">
                                                <img src="" class="w-70 " style="width: 300px" id="img_edit3"
                                                    alt="">
                                            </div>
                                            <label class="form-label" for="customFile">
                                                {{ __('validation.choose_img') }}
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response) {
                            ...
                            $('.des_en').val(response.des_en)
                            $('.des_ar').val(response.des_ar)
