...
@section('Front-container')
    <style>
        ...
        @media(max-width:570px) {
            ...
            .mobile-margin-zero-bottom {
                margin-bottom: 0 !important;
                margin-top: 0 !important;
            }

            .mobile-margin-zero-top {
                margin-top: 0 !important;
    ...
    <div class="background-dark-main-color">
            ...
            <section class="testimonials-two mt-5 "
                ...
                <div class="container">
                    <div class="section-title color-two text-start">
                        <h1 class=" wow slideInLeft   text-secondry-color "
                            style="visibility: visible; animation-name: pixFadeUp;">
        ...
        <section class="testimonials-two pt-5">
            <div class="container">
                <div class="section-title color-two text-center mobile-margin-zero-bottom">
                    <h2 class=" wow pixFadeUp  pb-2 text-white" style="visibility: visible; animation-name: pixFadeUp;">
                                            ...
                                            <div class="tech_box">
                                                {{-- <div class="row flex-center align-items-center"
                                                    ...
                                                    <img src="{{ $item->img }}" class="wow pixFadeRight "
                                                        style="height: 100%" data-wow-delay="0.3s" alt="feature-image">
                                                ...
                                                <div class="row "
                                                    style="height: 50px; gap:10px; margin-left:0px;margin-right:0px;">
                                                    <div
                                                        style="padding-left:10px; padding-right:10px; height:100%; width:45%;flex:1;">
                                                        <img src="{{ $item->img }}" class="wow pixFadeRight "
                                                            style="height: 100%" data-wow-delay="0.3s" alt="feature-image">
                                                    </div>
                                                    <div
                                                        style="flex:1;width:65%; display:flex; align-items:center; justify-content:center">
                                                        <h6 class="m-0 wow pixFadeUp font-Light text-main-color"
                                                            style="visibility: visible; animation-name: pixFadeUp; ">
                                                            {{ config('app.locale') == 'en' ? $item->name_en : $item->name_ar }}
                                                        </h6>
                    ...
                    <h2 class=" wow pixFadeUp  pb-2 text-white mt-3 "
                        style="visibility: visible; animation-name: pixFadeUp;">
                        <span class="text-secondry-color">
                            << </span>
                                            ...
                                            <div class="tech_box">
                                                <div class="row "
                                                    ...
                                                    <div
                                                        style="padding-left:10px; padding-right:10px; height:100%; width:45%;flex:1;">
                                                        <img src="{{ $item->img }}" class="wow pixFadeRight "
                                                            style="height: 100%" data-wow-delay="0.3s"
                                                            alt="feature-image">
                                                    </div>
                                                    <div
                                                        style="flex:1;width:65%; display:flex; align-items:center; justify-content:center">
        ...
        @if ($who_we_serve)
            <section class="testimonials-two mobile-margin-zero-top"
